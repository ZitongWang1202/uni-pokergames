...

        {
            ...
            rows: [
                ...
                },
                {
                    ...
                    ], '最大：大王', ['大小顺序：大王（红Joker）＞小王（黑Joker）＞2＞A＞K＞Q＞J＞10＞9＞8＞7＞6＞5＞4＞3，不分花色']]
                },
                {
                    type: 'normal',
                    data: ['对子', [
                ...
                },
                {
                    ...
                    data: ['三带', [
                        ...
                        },
                        {
                            ...
                            '• 只有牌型与张数均相同时才能按其中三张最大牌张点数比较大小。不分花色，带牌不影响大小',
                            '• 大小顺序同单牌（除去大小王）'
                        ]]
                },
                {
                ...
                },
                {
                    ...
                    data: ['飞机带翅膀', [
                        ...
                        },
                        {
                            ...
                            '• 只有牌型与张数均相同时才能按其中三张的最大牌张点数比较大小。不分花色，带牌不影响大小',
                            '• 大小顺序同单牌（除去大小王）'
                        ]]
                },
                {
                    ...
                    data: ['四带二', [
                        ...
                        },
                        {
                            ...
                            '• 只有牌型与张数均相同时才能按其中炸弹的最大牌张点数比较大小。带牌不影响大小',
                            '• 大小顺序同单牌（除去大小王）'
                        ]]
                },
                {
