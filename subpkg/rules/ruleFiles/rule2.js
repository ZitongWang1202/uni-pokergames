export const rule2 = {
    ...
    sections: [
        ...
        {
            type: 'text',
            content: '随机决定一个玩家成为第一局的庄家，之后上局的赢家成为庄家。庄家有第一轮出牌权。'
        },
        {
            type: 'text',
            content: '游戏开始后，庄家发 6 张牌，其余人发 5 张牌。剩下的牌做为底牌。'
        },
        ...
        {
            type: 'text',
            content: '当没有其他玩家可以或愿意出牌时，一轮牌**最后出牌的玩家**补一张牌，进入下一轮。如果牌抓完则每人凭手上的牌继续玩下去。第一个出完手中所有牌的玩家胜利，其余玩家失败。'
        },
        {
            type: 'text',
            content: '单张，顺子，对子，连对的牌型，必须点数**正好大过一点**才可以大过。'
        },
        {
            type: 'text',
            content: '干瞪眼的牌型跟牌规则和其他特殊牌型如下表：'
        },
        {
            type: 'table',
        ...
        {
            type: 'text',
            content: '每轮对局结束后，赢家的得分为输家所输分数之和。',
            isScoring: true
        },
        {
            type: 'text',
            content: '输家所输分数为所剩牌数 * 公共倍数 * 个人倍数',
            isScoring: true
        },
        {
            type: 'text',
            content: '公共倍数初始为 1，每出过一个炸弹倍数 * 2',
            isScoring: true
        },
        {
            type: 'text',
            content: '个人倍数初始为 1，剩下的牌中每剩一个炸弹倍数 * 2，每剩一个王倍数 * 2',
            isScoring: true
        },
    ],
    counters: [
